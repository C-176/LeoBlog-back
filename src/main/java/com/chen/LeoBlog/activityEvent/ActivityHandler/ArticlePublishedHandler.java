...
@Component
@Slf4j
public class ArticlePublishedHandler extends AbstractActivityHandler {
    ...
    public ActivityEnum getActivityEventType() {
        return ActivityEnum.ARTICLE_PUBLISH;
    }

    @Override
    public String generateTitle(Activity activity) {
        return "发布新文章：" + activity.getActivityData().getArticleTitle();
    }
}
