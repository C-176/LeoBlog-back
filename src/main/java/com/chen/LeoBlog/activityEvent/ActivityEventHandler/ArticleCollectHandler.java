...
@Component
@Slf4j
public class ArticleCollectHandler extends AbstractActivityEventHandler {
    ...
    public ActivityEventEnum getActivityEventType() {
        return ActivityEventEnum.ARTICLE_COLLECT;
    }

    @Override
    public String generateTitle(ActivityEvent activityEvent) {
        return "收藏了文章：" + activityEvent.getEventData().getArticleTitle();
    }
}
